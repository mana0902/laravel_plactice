  ...
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="-m-2">
        ...
        <div class="p-2 w-1/2 my-4 mx-auto">
          <div class="relative">
        ...
        <div class="p-2 w-1/2 my-4 mx-auto">
          <div class="relative">
            <label for="password" class="leading-7 text-sm text-gray-600" required>パスワード</label>
        ...
        <div class="p-2 w-1/2 my-4 mx-auto">
          <div class="relative">
            <label for="password-confimation" class="leading-7 text-sm text-gray-600" required>パスワード確認</label>
            <input type="password" id="password-confimation" name="password-confimation" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
          </div>
        </div>
