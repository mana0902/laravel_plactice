  ...
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      ...
      <div class="-m-2">
        ...
        <div class="p-2 w-1/2 my-4 mx-auto">
          <div class="relative">
            <label for="shop" class="leading-7 text-sm text-gray-600" required></label>
        ...
        <div class="p-2 w-1/2 my-4 mx-auto">
          <div class="relative">
            <label for="password_confirmation" class="leading-7 text-sm text-gray-600" required>パスワード確認</label>
